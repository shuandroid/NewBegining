...
/**
 *  Created by @author chen.zhao, on @date 2018/6/28  下午8:15
 */
class ClearEditText @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null,
    ...
    //todo 虽然用一个控件会好一些，但我更习惯用 两个 view ，EditText, 和 View 两个来完成事件的处理
    ...
    private fun init() {
        // 获取EditText的DrawableRight,假如没有设置我们就使用默认的图片, 图片的顺序是左上右下（0,1,2,3,）
